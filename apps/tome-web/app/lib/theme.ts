...
export const tokens = (theme: Theme) => ({
	...
	...generatePalette({ hue: 50, mode: theme.mode, transform: sameAsInput, prefix: 'neutral-', chroma: 0.1 }),
	...generatePalette({ hue: 50, mode: theme.mode, transform: sameAsInput, prefix: 'accent-', chroma: 1.25 }),
