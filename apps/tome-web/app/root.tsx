				...
				<svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="0" height="0">
					<defs>
						...
						<symbol viewBox="0 0 100 175" stroke="none" fill="currentColor" id="bookmark-blue">
							<path
								d="M0 -0.00012207V150H14.2189C21.0711 150 27.5908 152.954 32.1095 158.105V158.105C41.5887 168.911 58.4113 168.911 67.8906 158.105V158.105C72.4092 152.954 78.9289 150 85.7811 150H100V-5.14984e-05L0 -0.00012207Z"
							/>
						</symbol>
					</defs>
				</svg>
